...
git config --global user.name "RafaelRibeirodeCampos"
git config --global user.email "rafael.campos77@etec.sp.gov.br"
echo 3 de 6: CONFIGURADO GLOBAL

:: Adiciona o repositório remoto (só executa se já não estiver adicionado)
git remote get-url origin >nul 2>&1
if errorlevel 1 (
    git remote add origin "https://github.com/RafaelRibeirodeCampos/AutoCarRepo.git"
